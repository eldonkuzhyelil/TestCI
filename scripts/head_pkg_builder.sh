...
#echo Changing working directory to "D:\Jenkins\workspace\FirstProject\TestCI"
#cd "D:\Jenkins\workspace\FirstProject\TestCI2"
pwd
# check for the existence of an existing commit file for this
# project
SCRIPTFILE="$WSPACE\lastcommit\$BNAME.txt"
...
EOF
        ...
        echo $LCOMMIT > "$WSPACE\lastcommit\$BNAME.txt"
